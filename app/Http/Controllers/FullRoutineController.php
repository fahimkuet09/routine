...
class FullRoutineController extends MasterController
{
    ...
    public function batch_wise_view(Request $request)
    {
        ...
        $slots = Day::with([
            'routine' => function ($query) use ($batch_id, $y_session_id, $section_id) {
                if ($section_id != '') {
    ...
    public function teacher_search()
    {
        ...
        $slots = Day::with([
            'routine' => function ($query) use ($y_session_id, $teacher_id) {
    ...
    public function teacher_wise_view(Request $request)
    {
        ...
        $slots = Day::with([
            'routine' => function ($query) use ($teacher_id, $y_session_id) {
